            ...
            @csrf
                    ...
                    <div class="grid grid-cols-1 space-y-2">
                        <label class="text-right text-sm font-bold text-gray-500 ">موضوع</label>
                            <input name="title" value="{{$post["title"]}}" class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="text">
                    ...
                    <div class="grid grid-cols-1 space-y-2">
                        ...
                        <textarea value="{{$post["description"]}}" class="text-right rounded-lg  border border-gray-300 leading-normal w-full h-40 py-2 px-3" name="description" placeholder='. . . بنوسید' required>{{$post["description"]}}</textarea>
                        >
                            @error("description")
                                <span class="text-red-500">{{$message}}</span>
                            @enderror
