    ...
    <main class="flex w-screen h-screen font-vazir md:justify-between ">
        ...
        from-blue-700 to-indigo-900 justify-center items-center">
            <div class="flex flex-col w-500 h-auto gap-2 " dir="rtl">
                ...
                <p class="text-white text-lg font-semibold">این چند وقته که نبودی دل ما برات تنگ شده بود ممنون که برگشتی</p>
        ...
        <button type="submit" class="mt-auto bg-green-500 transition-colors delay-150 hover:bg-green-700 text-white py-2 rounded-xl font-black">ورود</button>
    </div>
        </form>
